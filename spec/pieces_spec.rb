...
describe Pieces do
  let(:dummy_class) { Class.new { extend Pieces } }

  describe '#construct_piece_from_fen_char' do
    subject { dummy_class }

    context 'when passed the character representing a white King' do
      let(:fen_char_white_king) { 'K' }

      it 'returns a King' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_king)
    ...
    context 'when passed the character representing a black King' do
      let(:fen_char_black_king) { 'k' }

      it 'returns a King' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_king)
        expect(result).to be_a(King)
      end
    ...
    context 'when passed the character representing a white Queen' do
      let(:fen_char_white_queen) { 'Q' }

      it 'returns a Queen' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_queen)
    ...
    context 'when passed the character representing a black Queen' do
      let(:fen_char_black_queen) { 'q' }

      it 'returns a Queen' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_queen)
        expect(result).to be_a(Queen)
      end
    ...
    context 'when passed the character representing a white Rook' do
      let(:fen_char_white_rook) { 'R' }

      it 'returns a Rook' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_rook)
    ...
    context 'when passed the character representing a black Rook' do
      let(:fen_char_black_rook) { 'r' }

      it 'returns a Rook' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_rook)
        expect(result).to be_a(Rook)
      end
    ...
    context 'when passed the character representing a white Bishop' do
      let(:fen_char_white_bishop) { 'B' }

      it 'returns a Bishop' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_bishop)
    ...
    context 'when passed the character representing a black Bishop' do
      let(:fen_char_black_bishop) { 'b' }

      it 'returns a Bishop' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_bishop)
        expect(result).to be_a(Bishop)
      end
    ...
    context 'when passed the character representing a white Knight' do
      let(:fen_char_white_knight) { 'N' }

      it 'returns a Knight' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_knight)
    ...
    context 'when passed the character representing a black Knight' do
      let(:fen_char_black_knight) { 'n' }

      it 'returns a Knight' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_knight)
        expect(result).to be_a(Knight)
      end
    ...
    context 'when passed the character representing a white Pawn' do
      let(:fen_char_white_pawn) { 'P' }

      it 'returns a Pawn' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_white_pawn)
    ...
    context 'when passed the character representing a black Pawn' do
      let(:fen_char_black_pawn) { 'p' }

      it 'returns a Pawn' do
        result = dummy_class.construct_piece_from_fen_char(fen_char_black_pawn)
        expect(result).to be_a(Pawn)
      end
  ...
  describe '#convert_piece_to_fen_char' do
    subject { dummy_class }

    context 'when passed a King with a white color' do
      it 'returns the character representing a white King' do
        king_white = double('King', white?: true, black?: false, class: King)
        result = dummy_class.convert_piece_to_fen_char(king_white)
    ...
    context 'when passed a King with a black color' do
      it 'returns the character representing a black King' do
        king_black = double('King', white?: false, black?: true, class: King)
        result = dummy_class.convert_piece_to_fen_char(king_black)
        expect(result).to eq('k')
      end
    end
    ...
    context 'when passed a Queen with a white color' do
      it 'returns the character representing a white Queen' do
        queen_white = double('Queen', white?: true, black?: false, class: Queen)
        result = dummy_class.convert_piece_to_fen_char(queen_white)
    ...
    context 'when passed a Queen with a black color' do
      it 'returns the character representing a black Queen' do
        queen_black = double('Queen', white?: false, black?: true, class: Queen)
        result = dummy_class.convert_piece_to_fen_char(queen_black)
        expect(result).to eq('q')
      end
    end
    ...
    context 'when passed a Rook with a white color' do
      it 'returns the character representing a white Rook' do
        rook_white = double('Rook', white?: true, black?: false, class: Rook)
        result = dummy_class.convert_piece_to_fen_char(rook_white)
    ...
    context 'when passed a Rook with a black color' do
      it 'returns the character representing a black Rook' do
        rook_black = double('Rook', white?: false, black?: true, class: Rook)
        result = dummy_class.convert_piece_to_fen_char(rook_black)
        expect(result).to eq('r')
      end
    end
    ...
    context 'when passed a Bishop with a white color' do
      it 'returns the character representing a white Bishop' do
        bishop_white = double('Bishop', white?: true, black?: false, class: Bishop)
        result = dummy_class.convert_piece_to_fen_char(bishop_white)
    ...
    context 'when passed a Bishop with a black color' do
      it 'returns the character representing a black Bishop' do
        bishop_black = double('Bishop', white?: false, black?: true, class: Bishop)
        result = dummy_class.convert_piece_to_fen_char(bishop_black)
        expect(result).to eq('b')
      end
    end
    ...
    context 'when passed a Knight with a white color' do
      it 'returns the character representing a white Knight' do
        knight_white = double('Knight', white?: true, black?: false, class: Knight)
        result = dummy_class.convert_piece_to_fen_char(knight_white)
    ...
    context 'when passed a Knight with a black color' do
      it 'returns the character representing a black Knight' do
        knight_black = double('Knight', white?: false, black?: true, class: Knight)
        result = dummy_class.convert_piece_to_fen_char(knight_black)
        expect(result).to eq('n')
      end
    end
    ...
    context 'when passed a Pawn with a white color' do
      it 'returns the character representing a white Pawn' do
        pawn_white = double('Pawn', white?: true, black?: false, class: Pawn)
        result = dummy_class.convert_piece_to_fen_char(pawn_white)
    ...
    context 'when passed a Pawn with a black color' do
      it 'returns the character representing a black Pawn' do
        pawn_black = double('Pawn', white?: false, black?: true, class: Pawn)
        result = dummy_class.convert_piece_to_fen_char(pawn_black)
        expect(result).to eq('p')
      end
    end
  end
