...
describe Knight do
  describe '#generate_adjacent_coords' do
    ...
    context 'when passed coordinates a8' do
      it 'returns an array of the knight\'s adjacent coordinates' do
        algebraic_a8 = 'a8'
    ...
    context 'when passed coordinates e4' do
      it 'returns an array of the knight\'s adjacent coordinates' do # rubocop:disable RSpec/ExampleLength
        algebraic_e4 = 'e4'
